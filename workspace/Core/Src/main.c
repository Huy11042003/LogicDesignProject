...
/* USER CODE END MX_GPIO_Init_1 */
  ...
  /*Configure GPIO pin Output Level */
  HAL_GPIO_WritePin(GPIOA, RED1_Pin|YELLOW1_Pin|GREEN1_Pin|YELLOW2_Pin, GPIO_PIN_RESET);

  /*Configure GPIO pin Output Level */
  HAL_GPIO_WritePin(GPIOA, B1_Pin|A1_Pin|RED2_Pin|GREEN2_Pin
                          |F1_Pin|G1_Pin|C1_Pin, GPIO_PIN_SET);
  ...
  /*Configure GPIO pins : E1_Pin D1_Pin LED9_Pin PB8
                           PB9 */
  GPIO_InitStruct.Pin = E1_Pin|D1_Pin|LED9_Pin|GPIO_PIN_8
                          |GPIO_PIN_9;
  GPIO_InitStruct.Mode = GPIO_MODE_OUTPUT_PP;
  GPIO_InitStruct.Pull = GPIO_NOPULL;
  GPIO_InitStruct.Speed = GPIO_SPEED_FREQ_LOW;
